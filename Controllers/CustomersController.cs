...
namespace AOWebApp.Controllers
{
    public class CustomersController : Controller
    {
        ...
        // GET: Customers
        public async Task<IActionResult> Index(string searchName, string searchSuburb)
        {
            #region suburbs
            ...
            {
                amazonDbContext = amazonDbContext.Where(c => c.FirstName.Contains(searchName));
            }
            if (!string.IsNullOrEmpty(searchSuburb))
            {
                amazonDbContext = amazonDbContext.Where(c => c.Address.Suburb == searchSuburb);
            }
      
            var customerList = await amazonDbContext.ToListAsync();
            var viewModel = new CustomeSearchViewModel
            {
                searchName = searchName,
                searchSuburb = searchSuburb,
                suburbs = new SelectList(suburbs),
